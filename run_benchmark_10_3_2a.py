#!/usr/bin/env python
"""Run Phase 10.3.2a benchmark with error handling."""
...
import time
import json
from backend.agent.phase_10_3.benchmark_10_3_2a import Phase10_3_2a_Benchmark
...
print("\nRunning benchmark suite (this may take a minute)...")
try:
    start = time.time()
...
try:
    ...
    print("[OK] Results saved to BENCHMARK_10_3_2a.json")
except Exception as e:
    print(f"[FAIL] Failed to save: {e}")
    sys.exit(1)

print("\n[OK] Phase 10.3.2a Benchmark Complete!")
